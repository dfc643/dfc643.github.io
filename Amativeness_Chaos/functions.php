...
function amativeness_setup() {
	...
	register_nav_menus( array(
		'primary'   => __( 'Top primary menu', 'amativeness' ),
		'secondary' => __( 'Secondary menu in left sidebar', 'amativeness' ),
	) );
...
QTags.addButton('pre','pre','<pre lang="php">','</pre>',''); //快捷输入一个hr横线，点一下即可 QTags.addButton( 'h3', 'h3', '\n<h3>', '</h3>\n' ); //快捷输入h3标签 QTags.addButton( '[php]', '[php]', '\n[php]', '[/php]\n' ); //快捷输入[php]标签 
...
function custum_fontfamily($initArray){
   $initArray['font_formats'] = "微软雅黑='微软雅黑';宋体='宋体';黑体='黑体';仿宋='仿宋';楷体='楷体';隶书='隶书';幼圆='幼圆';Arial='Arial';Adale Mono='Adale Mono';Arial Black='Arial Black';";
   return $initArray;
}
