	...
	<footer id="colophon" role="contentinfo" itemscope="" itemtype="https://schema.org/WPFooter">
        ...
        <div class="container">
            ...
            <p>&copy; 2016 <a href="<?php echo home_url(); ?>/"><?php bloginfo('name'); ?></a>.
                ...
                Theme By <a href="https://blog.aillen.org" target="_blank">Amativeness</a>.
                <a href="https://blog.aillen.org/sitemap.xml" target="_blank">站点地图</a>.
                
            </p>
            <p>Made with <i class="fa fa-heart throb" style="color: #d43f57;"></i> by Chaos. </p>
        </div>
    </footer> <!-- #colophon -->
