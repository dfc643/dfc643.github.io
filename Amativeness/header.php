...
<!--<![endif]-->
<head>
<link rel="shortcut icon" href="http://www.fcsys.us/logo/fsnb.png" />
...
<?php endif; ?>
	...
	<ul class="nav">
        ...
        <li><a class="fuser" href="<?php bloginfo('url');?>/wp-login.php" title="登录"></a></li>
     </ul>
	</div>
</div>
...
<div id="information" class="info block">
                <a href="<?php echo esc_url( home_url( '/' ) ); ?>"><?php echo get_avatar(1,100); ?></a>
