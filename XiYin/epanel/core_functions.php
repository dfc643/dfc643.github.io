...
function et_add_epanel() {
    ...
    $core_page = add_theme_page( $themename . ' ' . esc_html__( 'Options', $themename ), esc_html__( '汐音主题选项', $themename ), 'switch_themes', basename(__FILE__), 'et_build_epanel' );
							...
							<div id="epanel-content">
								...
								<ul id="epanel-mainmenu">
									<?php if(in_array('general',$epanelMainTabs)) { ?>
										<li><a href="#wrap-general"><img src="<?php echo get_template_directory_uri() ?>/epanel/images/general-icon.png" class="pngfix" alt="" /><?php esc_html_e( '通用', $themename ); ?></a></li>
									<?php }; ?>
									<?php if(in_array('navigation',$epanelMainTabs)) { ?>
										<li><a href="#wrap-navigation"><img src="<?php echo get_template_directory_uri() ?>/epanel/images/navigation-icon.png" class="pngfix" alt="" /><?php esc_html_e( '导航', $themename ); ?></a></li>
									<?php }; ?>
									<?php if(in_array('layout',$epanelMainTabs)) { ?>
										<li><a href="#wrap-layout"><img src="<?php echo get_template_directory_uri() ?>/epanel/images/layout-icon.png" class="pngfix" alt="" /><?php esc_html_e( '布局', $themename ); ?></a></li>
									<?php }; ?>
									<?php if(in_array('ad',$epanelMainTabs)) { ?>
										<li><a href="#wrap-advertisements"><img src="<?php echo get_template_directory_uri() ?>/epanel/images/ad-icon.png" class="pngfix" alt="" /><?php esc_html_e( '广告', $themename ); ?></a></li>
									<?php }; ?>
									<?php if(in_array('colorization',$epanelMainTabs)) { ?>
										<li><a href="#wrap-colorization"><img src="<?php echo get_template_directory_uri() ?>/epanel/images/colorization-icon.png" class="pngfix" alt="" /><?php esc_html_e( '配色', $themename ); ?></a></li>
									<?php }; ?>
									...
									<?php if(in_array('integration',$epanelMainTabs)) { ?>
										<li><a href="#wrap-integration"><img src="<?php echo get_template_directory_uri() ?>/epanel/images/integration-icon.png" class="pngfix" alt="" /><?php esc_html_e( '代码', $themename ); ?></a></li>
									<?php }; ?>
									<?php if(in_array('support',$epanelMainTabs)) { ?>
										<li><a href="#wrap-support"><img src="<?php echo get_template_directory_uri() ?>/epanel/images/support-icon.png" class="pngfix" alt="" /><?php esc_html_e( '帮助', $themename ); ?></a></li>
									<?php }; ?>
						...
						<div class="box-content">
							...
							<?php } elseif ( 'upload' == $value['type'] ) { ?>
								...
								<div class="upload_buttons">
									<span class="upload_image_reset"><?php esc_html_e( '重置', $themename ); ?></span>
									<input class="upload_image_button" type="button" value="<?php esc_attr_e( '上传图片', $themename ); ?>" />
								</div>
